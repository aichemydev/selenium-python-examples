...
def view_profile(driver, timeout_sec):
    ...
    friends_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//h2/span/a[contains(text(), 'Friends')]")
    logger.info("[TEST] clicking friends_btn button")
    friends_btn.click()
    time.sleep(timeout_sec*1.5)

    logger.info("[TEST] finding sports_btn button")
    sports_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//a[contains(text(), 'Sports')]")
    logger.info("[TEST] clicking sports_btn button")
    sports_btn.click()
    time.sleep(timeout_sec*1.5)

    logger.info("[TEST] finding music_btn button")
    music_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//a[contains(text(), 'Music')]")
    logger.info("[TEST] clicking music_btn button")
    music_btn.click()
    time.sleep(timeout_sec*1.5)

    logger.info("[TEST] finding movies_btn button")
    movies_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//a[contains(text(), 'Movies')]")
    ...
    books_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//a[contains(text(), 'Books')]")
    logger.info("[TEST] clicking books_btn button")
    books_btn.click()
    time.sleep(timeout_sec*1.5)

    logger.info("[TEST] finding likes_btn button")
    likes_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//a[contains(text(), 'Likes')]")
    logger.info("[TEST] clicking likes_btn button")
    likes_btn.click()
    time.sleep(timeout_sec*1.5)

    logger.info("[TEST] finding questions_btn button")
    questions_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//a[contains(text(), 'Questions')]")
    logger.info("[TEST] clicking questions_btn button")
    questions_btn.click()
    time.sleep(timeout_sec*1.5)

    logger.info("[TEST] finding groups_btn button")
    groups_btn = driver.find_element_by_xpath("//div[@class='bp9cbjyn j83agx80 cbu4d94t d2edcug0']//a[contains(text(), 'Groups')]")
